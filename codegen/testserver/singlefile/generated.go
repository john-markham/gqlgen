...
func (ec *executionContext) field_Query_directiveInputType_argsArg(
	...
	if data, ok := tmp.(InnerInput); ok {
		...
		var zeroVal InnerInput
		return zeroVal, graphql.ErrorOnPath(ctx, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/singlefile.InnerInput`, tmp))
	}
}
...
func (ec *executionContext) _Query_directiveObject(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/john-markham/gqlgen/codegen/testserver/singlefile.ObjectDirectives`, tmp)
	})
...
func (ec *executionContext) _Query_noShape(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/singlefile.Shape`, tmp)
	})
...
func (ec *executionContext) _Query_animal(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/singlefile.Animal`, tmp)
	})
	...
	for _, k := range fieldsInOrder {
		...
		case "inner":
			...
			if data, ok := tmp.(*InnerDirectives); ok {
				...
				err := fmt.Errorf(`unexpected type %T from directive, should be *github.com/john-markham/gqlgen/codegen/testserver/singlefile.InnerDirectives`, tmp)
				return it, graphql.ErrorOnPath(ctx, err)
			}
		case "innerNullable":
		...
		case "thirdParty":
			...
			if data, ok := tmp.(*ThirdParty); ok {
				...
				err := fmt.Errorf(`unexpected type %T from directive, should be *github.com/john-markham/gqlgen/codegen/testserver/singlefile.ThirdParty`, tmp)
				return it, graphql.ErrorOnPath(ctx, err)
			}
		}
	}
