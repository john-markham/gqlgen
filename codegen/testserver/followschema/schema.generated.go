...
import (
	...
	introspection1 "github.com/john-markham/gqlgen/codegen/testserver/followschema/introspection"
	invalid_packagename "github.com/john-markham/gqlgen/codegen/testserver/followschema/invalid-packagename"
	"github.com/john-markham/gqlgen/codegen/testserver/followschema/otherpkg"
...
func (ec *executionContext) field_Query_directiveInputType_argsArg(
	...
	if data, ok := tmp.(InnerInput); ok {
		...
		var zeroVal InnerInput
		return zeroVal, graphql.ErrorOnPath(ctx, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/followschema.InnerInput`, tmp))
	}
}
...
func (ec *executionContext) _Query_directiveObject(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/john-markham/gqlgen/codegen/testserver/followschema.ObjectDirectives`, tmp)
	})
...
func (ec *executionContext) _Query_noShape(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/followschema.Shape`, tmp)
	})
...
func (ec *executionContext) _Query_animal(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (any, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/john-markham/gqlgen/codegen/testserver/followschema.Animal`, tmp)
	})
